...
func TestCorrelateExactMissingMultipleConflictingEvidence(t *testing.T) {
	...
	exact := Correlate(pkg, []Candidate{{Ref: ref, Revision: "v1.0.0", Evidence: Evidence{Source: "repository", URL: ref.URL}}})
	if exact.Confidence != ConfidenceReleaseTagMatch || exact.Ambiguous {
